...
const ProductCrd = ({productList}: Iprops) => {
    ...
    return (
        <div key={productList.id} className="border border-gray-300 bg-amber-5 rounded-md p-2 flex gap-0.5 flex-col items-start">
            ...
            <p className="text-gray-600">{textSlicer(productList.description, 100)}</p>
                ...
                <div className="flex space-x-2 mt-2  justify-between items-stretch w-full">
                    <Button className="bg-blue-500 text-white hover:bg-blue-600" width="w-full">Add to Cart</Button>
                    <Button className="bg-gray-500 text-white hover:bg-gray-600" width="w-full">View Details</Button>       
